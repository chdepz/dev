      ...
      >
        <div
          className={classNames(
            "relative flex h-[70px] w-[70px] transform items-center justify-center rounded-full bg-slate-200 shadow-md ring-0 ring-gray-300 ring-opacity-30 transition-all duration-200 hover:ring-8",
            { "ring-4": active }
          )}
        >
          <div
