    ...
    <div className="relative h-full w-full ">
      ...
      >
        <h1
          ...
          data-animation="text"
        >
          <span className="relative z-10">Hi, I&apos;m Dipak Chaudhary</span>
        </h1>
        <h2
          className="bottom-clipped inline-block translate-y-7 overflow-hidden text-center font-anek-bangla text-base font-normal text-black opacity-0 sm:text-xl lg:max-w-[50%] lg:text-2xl"
          data-animation="text"
        >
          A seasoned Backend developer with a passion for creating engaging
          and intuitive websites and server-side applications.
        </h2>
