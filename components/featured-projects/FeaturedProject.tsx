    ...
    >
      <div className="centered-block flex h-full flex-col items-center gap-10 lg:flex-row">
        ...
        <div className="flex w-full flex-col justify-start gap-3 lg:w-1/2">
          <h2
            data-animation="text"
            className="mr-1 font-anek-bangla text-3xl font-light text-raisin-black"
          >
            {name}
          </h2>
          ...
          <Text className="text-black  font-anek-bangla">{description}</Text>
          ...
          {link && (
            <a
              ...
              target="_blank"
              rel="nofollow"
              className="flex gap-1 text-base text-black sm:text-lg"
            >
