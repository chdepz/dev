...
export default function About() {
  return (
    <div
      ...
      id="about"
    >
      <div className="mb-9 w-full lg:mb-0 lg:w-1/2 font-anek-bangla ">
        <Heading className="font-light">About Me</Heading>
        <Text className="mb-4 font-anek-bangla text-black">
          I&apos;m a passionate fullStack developer with a journey spanning
        ...
        <Text className="font-anek-bangla text-black">
      ...
      <div className="flex w-full flex-col items-start justify-center lg:w-1/2">
        <h2 className="mb-6 font-anek-bangla text-2xl  text-raisin-black sm:text-3xl font-light">
          Main Skills
        </h2>
        ...
        <h3 className="mb-5 font-anek-bangla text-xl font-light text-raisin-black sm:text-2xl">
          Other Skills
        </h3>
        <div className="mb-7 flex flex-wrap gap-3 font-anek-bangla text-black">
